...
const Home = () => {
  ...
  return (
    <div className=" font-mono bg-blue-300">
      <div className='overflow-x-hidden font-serif pt-24'>
        <h1 className='uppercase text-4xl font-bold text-center pt-6 '>Artogram</h1>
        <div className='grid-cols-1 md:flex justify-between items-center space-y-10 md:px-20 px-3  md:space-x-20 space-x-4'>
          <div className='md:h-2/6 md:w-4/6'>
            <img className='md:h-2/4 ' src= {HomePic}/>
          </div>
          <div className='md:w-full md:pr-32'>
            <h1 className='font-bold text-xl md:text-3xl md:py-5 py-2'>Artisanal Essence, Handcrafted Connections.</h1>
            ...
            <div className='flex gap-10 justify-center py-10 pb-10'>
              <button className='border-gray-500 border-2 rounded-lg bg-white px-10 py-2 hover:scale-105 hover:bg-red-700  font-semibold hover:shadow-2xl' onClick={() => { navigation('/buy') }}>Buy →</button>

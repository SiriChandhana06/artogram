      ...
      <div>
        <section class="py-20 bg-blue-300">
          <div class="">
            ...
            <div class=" w-full md:mx-20 mx-5 md:flex md:space-x-20 space-x-5 pt-16">
              <div className="">
                <img className=' h-96 md:mx-20 mx-5 w-auto' src={ContactPic} alt="" />
              </div>
              ...
              <form ref={form} onSubmit={sendEmail}>
                ...
                <label
                  ...
                  <input type="text" name="user_name" required
                    class="peer block min-h-[auto] mt-2 md:w-96 w-80 text-left md:ml-0 rounded-lg border-black bg-white text-black border-2 bg-transparent py-3 px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                     placeholder="Name" /> 
                </div>
                <div class=" mb-6" data-te-input-wrapper-init>
                  <label
                ...
                <div class="" data-te-input-wrapper-init>
                  <label for="exampleFormControlTextarea1"
                    ...
                    class="peer block min-h-[auto] w-80 md:w-full my-3 rounded-lg border-black border-2 bg-white text-left md:ml-0 bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
